...
const BrainNote = ({ note }) => {
  ...
  return (
    <MDXProvider components={{ a: AnchorTagWithPopups }}>
      ...
      <div className="refs-box rounded-lg mb-4 p-4" style={{
        background: '#2ED1A210',
        color: '#1c1c1c'
      }}>
        {referenceBlock}
        <p className="text-sm m-0">
          These notes are still a work in progress. If you have comments or feedback you can reach me out {' '}
          <a style={{
            color: '#00C78B'
          }} href="https://twitter.com/juliancanderson">on Twitter</a>{' '}
          or send me an <a style={{
            color: '#00C78B'
          }} href="mailto:hello@juliancanderson.com">email</a>.
        </p>
      </div>
    </MDXProvider>
  );
